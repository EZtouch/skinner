...
public class MorphingHandler
{
	...
	public static void Normal()
	{
			...
			try
			{
				urlLink = new URL("https://minecraft.net/profile/skin/remote?url=https://lh3.googleusercontent.com/ss8A0ZJdQe_Nd-XkxwCS-UDn7mR4Q6mRslnfQ0GimITPVZiXPi7zrd8GiqgmHGu-W5blMeU2l17sv6s=w1896-h791");
			} catch (MalformedURLException e1)
			{
				// TODO Auto-generated catch block
				e1.printStackTrace();
